...
The current version of the Core Person Vocabulary can be downloaded from [https://semiceu.github.io/Core-Person-Vocabulary/releases/2.1.0/](https://semiceu.github.io/Core-Person-Vocabulary/releases/2.1.0/).
